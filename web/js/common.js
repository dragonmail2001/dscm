/*
 * Copyright 2005-2013 showcoo.net. All rights reserved.
 * Support: http://www.showcoo.net
 * License: http://www.showcoo.net/license
 * 
 * JavaScript - Common
 * Version: 3.0
 */
	...
	$.fn.extend({
		browser: function(options) {
			var settings = {
				...
				isUpload: true,
				browserUrl: shop.base + "/admin/file/browser.cgi",
				uploadUrl: shop.base + "/admin/file/upload.cgi",
				callback: null
			};
			$.extend(settings, options);
					...
					function createBrowserList(path, data) {
						...
						$.each(data, function(i, fileInfo) {
							...
							if (fileInfo.isDirectory) {
								iconUrl = shop.staticPath + "/y/admin/images/folder_icon.gif";
								title = fileInfo.name;
								...
								iconUrl = shop.staticPath + "/y/admin/images/file_icon.gif";
								title = fileInfo.name + " (" + Math.ceil(fileInfo.size / 1024) + "KB, " + new Date(fileInfo.lastModified).toLocaleString() + ")";
							}
