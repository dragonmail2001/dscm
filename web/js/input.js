...
$().ready( function() {
	...
	if($.validator != null) {
		$.extend($.validator.messages, {
			...
			illegal: message("admin.validate.illegal"),
			exist: message("admin.validate.exist")
		});
...
if(typeof(KindEditor) != "undefined") {
	KindEditor.ready(function(K) {
		editor = K.create("#editor", {
			...
			filePostName: "file",
			fileManagerJson: shop.base + "/admin/file/browser.cgi",
			uploadJson: shop.base + "/admin/file/upload.cgi",
