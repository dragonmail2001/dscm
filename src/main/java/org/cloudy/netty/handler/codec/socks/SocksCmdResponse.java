 ...
 * under the License.
 */
package org.cloudy.netty.handler.codec.socks;

import org.cloudy.netty.buffer.ByteBuf;
import org.cloudy.netty.util.CharsetUtil;
import org.cloudy.netty.util.NetUtil;
...
public final class SocksCmdResponse extends SocksResponse {
    ...
    /**
     * Returns host that is used as a parameter in {@link org.cloudy.netty.handler.codec.socks.SocksCmdType}.
     ...
     *
     * @return host that is used as a parameter in {@link org.cloudy.netty.handler.codec.socks.SocksCmdType}
    ...
    /**
     * Returns port that is used as a parameter in {@link org.cloudy.netty.handler.codec.socks.SocksCmdType}.
     * Port (BND.PORT field in response) is port that the server assigned to connect to the target host.
     *
     * @return port that is used as a parameter in {@link org.cloudy.netty.handler.codec.socks.SocksCmdType}
     */
    public int port() {
        return port;
    }
