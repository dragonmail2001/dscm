...
public abstract class Recycler<T> {
    ...
    static {
        ...
        // e.g. org.cloudy.netty.recycler.maxCapacity.writeTask
        //      org.cloudy.netty.recycler.maxCapacity.outboundBuffer
        int maxCapacity = SystemPropertyUtil.getInt("org.cloudy.netty.recycler.maxCapacity.default",
        ...
        if (logger.isDebugEnabled()) {
            if (DEFAULT_MAX_CAPACITY == 0) {
                logger.debug("-Dorg.cloudy.netty.recycler.maxCapacity.default: disabled");
            } else {
                logger.debug("-Dorg.cloudy.netty.recycler.maxCapacity.default: {}", DEFAULT_MAX_CAPACITY);
            }
        }
