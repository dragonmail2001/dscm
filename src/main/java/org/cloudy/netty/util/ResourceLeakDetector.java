...
package org.cloudy.netty.util;

import org.cloudy.netty.util.internal.MathUtil;
...
import static org.cloudy.netty.util.internal.StringUtil.EMPTY_STRING;
import static org.cloudy.netty.util.internal.StringUtil.NEWLINE;
import static org.cloudy.netty.util.internal.StringUtil.simpleClassName;

public final class ResourceLeakDetector<T> {

    private static final String PROP_LEVEL_OLD = "org.cloudy.netty.leakDetectionLevel";
    private static final String PROP_LEVEL = "org.cloudy.netty.leakDetection.level";
    private static final Level DEFAULT_LEVEL = Level.SIMPLE;

    private static final String PROP_MAX_RECORDS = "org.cloudy.netty.leakDetection.maxRecords";
    ...
    static {
        ...
        if (SystemPropertyUtil.get("org.cloudy.netty.noResourceLeakDetection") != null) {
            disabled = SystemPropertyUtil.getBoolean("org.cloudy.netty.noResourceLeakDetection", false);
            logger.debug("-Dorg.cloudy.netty.noResourceLeakDetection: {}", disabled);
            logger.warn(
                    "-Dorg.cloudy.netty.noResourceLeakDetection is deprecated. Use '-D{}={}' instead.",
    ...
    private static final String[] STACK_TRACE_ELEMENT_EXCLUSIONS = {
            "org.cloudy.netty.buffer.AbstractByteBufAllocator.toLeakAwareBuffer(",
            "org.cloudy.netty.buffer.AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation("
    };
