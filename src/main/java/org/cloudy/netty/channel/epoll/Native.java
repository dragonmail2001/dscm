...
import org.cloudy.netty.channel.DefaultFileRegion;
import org.cloudy.netty.channel.unix.Errors.NativeIoException;
import org.cloudy.netty.util.internal.NativeLibraryLoader;
...
import org.cloudy.netty.channel.unix.NativeInetAddress;

import java.io.IOException;
import java.net.InetAddress;
import java.util.Locale;

import static org.cloudy.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollerr;
import static org.cloudy.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollet;
import static org.cloudy.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollin;
import static org.cloudy.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollout;
import static org.cloudy.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollrdhup;
import static org.cloudy.netty.channel.epoll.NativeStaticallyReferencedJniMethods.iovMax;
import static org.cloudy.netty.channel.epoll.NativeStaticallyReferencedJniMethods.isSupportingSendmmsg;
import static org.cloudy.netty.channel.epoll.NativeStaticallyReferencedJniMethods.isSupportingTcpFastopen;
import static org.cloudy.netty.channel.epoll.NativeStaticallyReferencedJniMethods.kernelVersion;
import static org.cloudy.netty.channel.epoll.NativeStaticallyReferencedJniMethods.ssizeMax;
import static org.cloudy.netty.channel.epoll.NativeStaticallyReferencedJniMethods.tcpMd5SigMaxKeyLen;
import static org.cloudy.netty.channel.epoll.NativeStaticallyReferencedJniMethods.uioMaxIov;
import static org.cloudy.netty.channel.unix.Errors.ERRNO_EAGAIN_NEGATIVE;
import static org.cloudy.netty.channel.unix.Errors.ERRNO_EPIPE_NEGATIVE;
import static org.cloudy.netty.channel.unix.Errors.ERRNO_EWOULDBLOCK_NEGATIVE;
import static org.cloudy.netty.channel.unix.Errors.ioResult;
import static org.cloudy.netty.channel.unix.Errors.newConnectionResetException;
import static org.cloudy.netty.channel.unix.Errors.newIOException;
...
public final class Native {
    static {
        ...
        NativeLibraryLoader.load(SystemPropertyUtil.get("org.cloudy.netty.packagePrefix", "").replace('.', '-') +
