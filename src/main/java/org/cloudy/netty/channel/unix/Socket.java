...
import static org.cloudy.netty.channel.unix.Errors.CONNECTION_NOT_CONNECTED_SHUTDOWN_EXCEPTION;
import static org.cloudy.netty.channel.unix.Errors.CONNECTION_RESET_EXCEPTION_SENDMSG;
import static org.cloudy.netty.channel.unix.Errors.CONNECTION_RESET_EXCEPTION_SENDTO;
import static org.cloudy.netty.channel.unix.Errors.ERRNO_EAGAIN_NEGATIVE;
import static org.cloudy.netty.channel.unix.Errors.ERRNO_EINPROGRESS_NEGATIVE;
...
import static org.cloudy.netty.channel.unix.Errors.newConnectException;
import static org.cloudy.netty.channel.unix.Errors.newIOException;
import static org.cloudy.netty.channel.unix.NativeInetAddress.address;
import static org.cloudy.netty.channel.unix.NativeInetAddress.ipv4MappedIpv6Address;
