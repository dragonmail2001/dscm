...
public interface DomainSocketChannelConfig extends ChannelConfig {
     ...
     * {@link org.cloudy.netty.channel.Channel} and passed through the pipeline. If
     * {@link DomainSocketReadMode#FILE_DESCRIPTORS} is used
     * {@link FileDescriptor}s will be passed through the {@link org.cloudy.netty.channel.ChannelPipeline}.
     *
