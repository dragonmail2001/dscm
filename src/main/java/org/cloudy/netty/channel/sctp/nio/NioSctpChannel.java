 ...
 * under the License.
 */
package org.cloudy.netty.channel.sctp.nio;
...
import org.cloudy.netty.channel.ChannelPromise;
import org.cloudy.netty.channel.RecvByteBufAllocator;
import org.cloudy.netty.channel.nio.AbstractNioMessageChannel;
import org.cloudy.netty.channel.sctp.DefaultSctpChannelConfig;
import org.cloudy.netty.channel.sctp.SctpChannelConfig;
import org.cloudy.netty.channel.sctp.SctpMessage;
import org.cloudy.netty.channel.sctp.SctpNotificationHandler;
import org.cloudy.netty.channel.sctp.SctpServerChannel;
import org.cloudy.netty.util.internal.OneTimeTask;
...
/**
 * {@link org.cloudy.netty.channel.sctp.SctpChannel} implementation which use non-blocking mode and allows to read /
 * write {@link SctpMessage}s to the underlying {@link SctpChannel}.
 *
 * Be aware that not all operations systems support SCTP. Please refer to the documentation of your operation system,
 * to understand what you need to do to use it. Also this feature is only supported on Java 7+.
 */
public class NioSctpChannel extends AbstractNioMessageChannel implements org.cloudy.netty.channel.sctp.SctpChannel {
