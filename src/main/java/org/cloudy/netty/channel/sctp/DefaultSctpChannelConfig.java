 ...
 * under the License.
 */
package org.cloudy.netty.channel.sctp;
...
import static org.cloudy.netty.channel.sctp.SctpChannelOption.*;
...
public class DefaultSctpChannelConfig extends DefaultChannelConfig implements SctpChannelConfig {
    ...
    public DefaultSctpChannelConfig(org.cloudy.netty.channel.sctp.SctpChannel channel, SctpChannel javaChannel) {
        super(channel);
        if (javaChannel == null) {
